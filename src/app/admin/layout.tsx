...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    <div className="flex min-h-screen bg-[#FAF6F0] text-[#2D1E17]">
      {/* Sidebar - Dark Sandalwood theme for premium contrast */}
              ...
              return (
                <div key={item.name} className="relative">
                  {isAllowed ? (
                    ...
                    <div className="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium text-white/20 cursor-not-allowed select-none bg-white/2">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-16 border-b border-[#EFE6DD] bg-white/80 backdrop-blur-md px-8 flex items-center justify-between sticky top-0 z-30 shadow-sm">
          ...
          {/* Role Switcher & Mock Notification Controls */}
